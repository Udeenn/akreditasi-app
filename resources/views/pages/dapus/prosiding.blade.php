...
@section('content')
    <div class="container-fluid px-3 px-md-4 pt-2 pb-4">
        ...
        <x-breadcrumb title="Statistik Koleksi Prosiding" icon="fas fa-file-alt">
            <x-slot name="subtitle">
                Data koleksi prosiding
                                @if ($prodi && $prodi !== 'all')
                                    — {{ $namaProdi }}
                                @elseif ($prodi === 'all')
                                    — Semua Program Studi
            ...
            <div class="col-12">
                <div class="card unified-card border-0 shadow-sm filter-card mb-4">
                    ...
                    <div class="card-body px-4 pb-4 pt-3">
                        <form method="GET" action="{{ route('koleksi.prosiding') }}" class="row g-3 align-items-end"
            ...
            <div class="card-body">
                ...
                @if ($prodi && $prodi !== 'initial' && $data->isNotEmpty())
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 unified-table" id="myTableProsiding">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Judul</th>
