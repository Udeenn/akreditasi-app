...
@section('content')
    <div class="container-fluid px-3 px-md-4 pt-2 pb-4">
        ...
        <x-breadcrumb title="Data Pelatihan" icon="fas fa-chalkboard-teacher">
            <x-slot name="subtitle">
                Kelola data pelatihan staff perpustakaan
            </x-slot>
        </x-breadcrumb>
            ...
            <div class="card-body">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    ...
                    <form action="{{ route('pelatihan.index') }}" method="GET" class="d-flex ms-auto">
                        ...
                        @if (request('search'))
                            <a href="{{ route('pelatihan.index') }}" class="btn btn-outline-secondary btn-sm px-4 fw-bold shadow-sm"><i class="fas fa-undo me-2"></i> Reset</a>
                        @endif
                    </form>
                </div>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0 unified-table text-center"
                        ...
                        <tbody>
                            @forelse ($pelatihan as $no => $item)
                                ...
                                @include('modal.edit-pelatihan', ['pelatihan' => $item])
                            @empty
                                <tr>
